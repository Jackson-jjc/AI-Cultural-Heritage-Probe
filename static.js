...
const landingCopy = {
  zh: {
    studyType:'研究参与网站', eyebrow:'以纺织文化遗产为例的博物馆 AI', titleA1:'AI 在博物馆中', titleA2:'可能适合做什么，', titleB1:'又可能', titleB2:'不适合做什么？',
    heroCredit:'《草莓小偷》纺织品，William Morris，1883 年',
    intro:'请选择研究者指定的一个情景。本 probe 以纺织文化遗产为具体案例，讨论 AI 在博物馆中可能适合做什么、需要什么条件，以及什么时候不适合使用。你会扮演一个具体角色，先根据少量背景作出第一反应，再查看一份近未来 AI 提案，并把它改成你认为更合适的版本。',
  ...
  en: {
    studyType:'Research participation website', eyebrow:'Museum AI through textile cultural heritage', titleA1:'Where might AI fit ', titleA2:'in museums', titleB1:'— and where might ', titleB2:'it not?',
    heroCredit:'Strawberry Thief, William Morris, 1883',
    intro:'Choose the situation assigned by the researcher. This probe uses textile cultural heritage as the concrete case for thinking about where AI may fit in museums, what conditions it needs, and where it may not be suitable. You will take on a specific role, give your first reaction from a short context, review a near-future AI proposal, then change it into a version that makes better sense to you.',
...
const ui = {
  ...
  ethicsPurpose:{zh:'研究目的：以纺织文化遗产为具体案例，了解人们如何看待博物馆与文化遗产情境中可能的 AI 应用。本研究不会测试正在运行的 AI 系统。',en:'Purpose: using textile cultural heritage as the concrete case, to understand how people make sense of possible uses of AI in museum and cultural heritage settings. This study does not test a live AI system.'},
...
const scenarioIndex = [
  ...
  {id:'S4',audience:{zh:'访客',en:'Visitor'},rolePrompt:{zh:'作为一名地方纺织与手工艺展览参观者',en:'As a visitor to a local textile and craft exhibition'},title:{zh:'一个小型纺织展览的访客支持选择',en:'Visitor support choices in a small textile exhibition'},descriptor:{zh:'翻译、简明文字与路线支持',en:'Translation, plain text and route support'},image:null,visual:'A / B / C',color:'#f4b8dc'}
];
...
const scenarios = {
  ...
  S2: {
    ...
    title:{zh:'一件仪式纺织品的多声部展示页',en:'A multi-voice display page for a ceremonial textile'},
    deck:{zh:'你需要决定：当馆藏记录、专家研究、社区说法和个人记忆不一致时，AI 只能整理这件仪式纺织品的材料，还是也可以改写和综合？',en:'You need to decide what AI may do when a collection record, specialist research, community wording and personal memory about a ceremonial textile do not fully agree.'},
    recap:{zh:'你是一名与社区合作的策展人员，正在审核一件仪式纺织品的数字展示页。不同材料对名称、用途和流转经历说法不完全一致，有些内容也可能需要社区许可。重点是决定 AI 只能整理材料，还是可以改写、翻译或综合。',en:'You are a curator working with communities, reviewing a digital display page for a ceremonial textile. Different materials disagree about its name, use and transfer history, and some content may need community permission. The focus is deciding whether AI may only organise material, or may also rewrite, translate or combine it.'},
    ...
    referenceObjects:[
      {title:{zh:'Ritual Textile (Pua Sungkit)',en:'Ritual Textile (Pua Sungkit)'},meta:{zh:'Iban people，婆罗洲，19 世纪早期至中期，棉',en:'Iban people, Borneo, early to mid-19th century, cotton'},image:'https://images.metmuseum.org/CRDImages/ao/web-large/DP-14456-001.jpg',url:'https://www.metmuseum.org/art/collection/search/626918',source:'The Metropolitan Museum of Art, Public Domain',note:{zh:'这个例子帮助说明：仪式纺织品可能同时涉及图案、地方知识、使用场合和社区解释，AI 不应只把它当成普通装饰图案来改写。',en:'This example shows that ritual textiles may involve pattern, local knowledge, use context and community interpretation, so AI should not treat them as ordinary decoration.'}},
      {title:{zh:'Ceremonial cloth',en:'Ceremonial cloth'},meta:{zh:'Iban-Dayak，婆罗洲，19 世纪，棉质 ikat 染织品',en:'Iban-Dayak, Borneo, 19th century, cotton ikat dyed textile'},image:'https://images.metmuseum.org/CRDImages/ao/web-large/DP-13017-021.jpg',url:'https://www.metmuseum.org/art/collection/search/742553',source:'The Metropolitan Museum of Art, Public Domain',note:{zh:'这个例子帮助说明：纺织品的图像和名称可能承载仪式、身份和地方历史，不同来源可能会给出不同解释。',en:'This example shows that textile imagery and naming may carry ritual, identity and local history, and different sources may give different interpretations.'}},
      {title:{zh:'Ceremonial Textile (Tampan)',en:'Ceremonial Textile (Tampan)'},meta:{zh:'Lampung，印度尼西亚苏门答腊，19 世纪，棉',en:'Lampung, Sumatra, Indonesia, 19th century, cotton'},image:'https://images.metmuseum.org/CRDImages/ao/web-large/DP-23874-001.jpg',url:'https://www.metmuseum.org/art/collection/search/316415',source:'The Metropolitan Museum of Art, Public Domain',note:{zh:'这个例子帮助说明：仪式纺织品可能与人生礼仪、交换和社会关系有关，公开展示或 AI 改写时需要考虑语境和责任。',en:'This example shows that ceremonial textiles may relate to rites of passage, exchange and social relationships, so public display or AI rewriting needs context and responsibility.'}}
    ],
    situation:{zh:'你正在帮助一家博物馆审核一件仪式纺织品的数字展示页。关于这件藏品，不同材料说法不完全一致：馆藏记录有一个名称和流转记录；专家研究提出另一种图案或用途解释；相关社区成员可能使用不同名称；一位讲述者还提供了个人记忆。有些知识可能不能公开，也不一定可以交给机器改写。博物馆正在确认展示许可，所以这里暂不显示这件研究构造藏品的图片。',en:'You are helping a museum review a digital page for a ceremonial textile. Different materials do not fully agree: the collection record gives one name and transfer history; specialist research offers another interpretation of pattern or use; related community members may use different names; and one contributor has shared a personal memory. Some knowledge may not be public, and may not be suitable for machine rewriting. The museum is still checking display permission, so the image of this research-created object is not shown here.'},
  ...
  S4: {
    ...
    title:{zh:'一个小型纺织展览的访客支持选择',en:'Visitor support choices in a small textile exhibition'},
    ...
    recap:{zh:'你是一名地方纺织与手工艺展览参观者。博物馆预算有限，只能先处理翻译、简明文字、短路线/无障碍路线中的一个方向，或先做一次很小的试验。重点是选择第一步，而不是设计一个完整大型 APP。',en:'You are a visitor to a local textile and craft exhibition. The museum has limited budget and can first address only one area: translation, plain text, or short/access route support, or run one small pilot. The focus is choosing a first step, not designing a large all-in-one app.'},
    examples:[{zh:'有访客看得懂展品，但希望织物工艺、图案含义或地方生活背景写得更短、更像普通说明。',en:'A visitor may understand the display but want shorter, plainer text about textile technique, pattern meaning or local life context.'},{zh:'有访客需要另一种语言，纸质翻译、二维码翻译或人工讲解都可能是选择。',en:'A visitor may need another language; paper translation, QR translation or staff explanation could all be options.'},{zh:'有访客只想走一条 20 分钟短路线，或需要更清楚的无障碍路线提示。',en:'A visitor may want a 20-minute short route or clearer accessible-route guidance.'}],
    situation:{zh:'你正在参观一家小型地方纺织与手工艺展览。展览介绍地方织物、刺绣、染色工艺和相关生活故事。参观结束时，博物馆请你帮忙选择下一步优先改善哪一项访客支持。大多数访客觉得展览基本清楚，但反馈反复提到三个问题：缺少另一种语言的翻译；有些关于工艺和图案的文字太长或不够简明；缺少清楚的短路线和无障碍路线。博物馆预算有限，不能同时解决三个问题，只能先做一项小改进，或做一次很小、可停止的试验。',en:'You are visiting a small local textile and craft exhibition. It presents local fabrics, embroidery, dyeing techniques and related everyday stories. At the end, the museum asks you to help choose which visitor-support issue to improve first. Most visitors find the exhibition broadly clear, but feedback repeatedly mentions three problems: no translation into another needed language; some text about techniques and patterns is too long or not plain enough; and there is no clear short or accessible route. The museum has limited budget. It cannot solve all three at once, so it can make one small improvement or run one small pilot that can be stopped.'},
